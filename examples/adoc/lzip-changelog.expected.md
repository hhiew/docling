// SPDX-FileCopyrightText: 2024 Shun Sakai // // SPDX-License-Identifier: CC-BY-4.0

# Changelog

:toc: preamble :project-url: https://github.com/sorairolake/lzip-go :compare-url: {project-url}/compare :issue-url: {project-url}/issues :pull-request-url: {project-url}/pull
...
({pull-request-url}/3[#3]) ({pull-request-url}/5[#5])
